 ...
 */
export function getPeriodStart(date, periodType = 'monthly') {
 ...
 */
export function getPeriodEnd(periodStart, periodType = 'monthly') {
 ...
 */
export function isInPeriod(ts, periodStart, periodEnd) {
 ...
 */
export function calculateWatermark(currentTs, latenessWindowHours = 48) {
 ...
 */
export function isEventTooLate(eventTs, watermarkTs, latenessWindowHours = 48) {
 ...
 */
export function getCurrentPeriod(periodType = 'monthly') {
    const now = new Date();
 ...
 */
export function calculateProration(startDate, endDate, periodStart, periodEnd) {
